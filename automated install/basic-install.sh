...
if command -v apt-get &> /dev/null; then
  ...
  PIHOLE_DEPS=(bc cron curl dnsutils iputils-ping lsof netcat sudo unzip wget idn2 sqlite3 libcap2-bin libnetfilter-conntrack3 libnfnetlink0 dns-root-data resolvconf)
